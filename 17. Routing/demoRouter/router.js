export default class Router {
    ...
    listen() {
        if (this.currentPath !== decodeURIComponent(document.location.pathname) || this.currentQueryString !== decodeURIComponent(document.location.search)) {
    ...
    loadPage() {
        ...
        if (route.length >= 2 && this.routes.hasOwnProperty(route[0]) && typeof(this.routes[route[0]][route[1]]) === 'function') {
